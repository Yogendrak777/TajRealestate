...
import { MobBaseContainer, LabelContainer, Label, Input, InputReviewContainer, DivisionBtn } from './Skins'
  ...
  const navigate = useNavigate();
    ...
    const ApartmentType = [
      ...
      const SubmitRequest = async() => {
        if (getDBData&&getBHKData&&getMaxPrice&&getMinPrice&& getDescription && getContentData){
        try {
          ...
          alert("Request submitted successfully, our agent will reach you in few minutes")
          navigate('/');
        } catch (e) {
          console.error(e)
        }
